...
export const drivers: Driver[] = [
  ...
  },
  {
    ...
    experienceYears: 10,
    car: car("Mercedes-Benz", "Classe S", 2023, "Noir", MERCEDES_S),
    categories: ["Luxury", "Business"],
    available: true,
    responseTime: "≈ 3 min",
    pricePerHour: 90,
    pricePerKm: 3.1,
    bio: "London-based executive chauffeur. Discreet, punctual and meticulous. Specialised in airport transfers (LHR, LCY), corporate roadshows and evening events across the city.",
    badges: ["Top Pro", "Verified"],
    mapX: 30,
    mapY: 24,
    reviews: [
      rev("r1", "Emma W.", "https://i.pravatar.cc/100?img=16", 5, "2 days ago", "Oliver was outstanding. Calm, professional and the S-Class was immaculate.", "Heathrow → Mayfair"),
      rev("r2", "Raj P.", "https://i.pravatar.cc/100?img=68", 5, "1 week ago", "Used him for a full day of meetings. Flawless service throughout."),
    ],
  },
  {
    id: "sofia-romano",
    ...
    reviewsCount: 156,
    trips: 720,
    languages: ["Español", "English", "Català", "Italiano"],
    experienceYears: 5,
    car: car("Tesla", "Model S Plaid", 2024, "Blanco Perla", TESLA),
    categories: ["Electric", "Luxury"],
    available: true,
    responseTime: "≈ 4 min",
    pricePerHour: 78,
    pricePerKm: 2.7,
    bio: "Conductora premium 100% eléctrica en Barcelona. Tecnología, silencio y cero emisiones. Perfecta para llegadas con estilo a eventos y traslados al aeropuerto El Prat.",
    badges: ["Verified", "Eco"],
    mapX: 45,
    mapY: 63,
    reviews: [
      rev("r1", "Pablo G.", "https://i.pravatar.cc/100?img=59", 5, "Hace 3 días", "Coche increíble y Sofia conduce de maravilla. Experiencia premium total.", "El Prat → Eixample"),
      rev("r2", "Hannah M.", "https://i.pravatar.cc/100?img=9", 4.5, "Hace 1 semana", "Loved the Tesla ride. Smooth and silent, great conversation."),
    ],
  },
  {
    id: "david-chen",
    ...
    experienceYears: 18,
    car: car("Cadillac", "Escalade ESV", 2024, "Black Raven", RANGE_ROVER),
    categories: ["SUV", "Luxury", "Business"],
    available: true,
    responseTime: "≈ 1 min",
    pricePerHour: 120,
    pricePerKm: 3.9,
    bio: "Manhattan's most requested executive driver. 18 years of five-star service for executives, celebrities and families. Privacy guaranteed, NDA available on request.",
    badges: ["Top Pro", "Verified", "Elite"],
    mapX: 75,
    mapY: 47,
    reviews: [
      rev("r1", "Michael S.", "https://i.pravatar.cc/100?img=64", 5, "Yesterday", "David is in a league of his own. On time, discreet, and the Escalade is a moving office.", "JFK → Tribeca"),
      rev("r2", "Olivia R.", "https://i.pravatar.cc/100?img=5", 5, "3 days ago", "Booked David for a week in NYC. Absolutely flawless every single day."),
      rev("r3", "Kenji T.", "https://i.pravatar.cc/100?img=70", 5, "1 week ago", "完美的服务，非常专业。强烈推荐！"),
    ],
  },
  {
    id: "lucas-martin",
  ...
  },
  {
    ...
    experienceYears: 6,
    car: car("Audi", "A8 L", 2024, "Mythos Black", AUDI_A8),
    categories: ["Business", "Luxury"],
    available: false,
    responseTime: "≈ 7 min",
    pricePerHour: 86,
    pricePerKm: 3.0,
    bio: "Refined executive chauffeur based in London. I deliver a calm, elegant and reliable experience for business travellers and discerning clients across the capital.",
    badges: ["Verified", "Top Pro"],
    mapX: 33,
    mapY: 28,
    reviews: [
      rev("r1", "Charlotte B.", "https://i.pravatar.cc/100?img=41", 5, "4 days ago", "Isabella is wonderful — punctual, elegant and so professional. The A8 is divine.", "City → Canary Wharf"),
      rev("r2", "Giulio M.", "https://i.pravatar.cc/100?img=58", 4.5, "1 week ago", "Servizio eccellente, autista molto gentile e professionale."),
    ],
  },
  {
    id: "jeremy-driver",
